 ...
 *
 * MJPEG uses a separate hardware engine (NvJPEGDecoder, not V4L2 M2M) with
 * its own init/decode/close/flush callbacks and no shared state with the
 * decoders below — see nvmpi_dec_mjpeg.c.
 *
